...
ENV MYSQL_MAJOR 8.0
ENV MYSQL_VERSION 8.0.0-dmr-1ubuntu16.04
...
##Try to avoid this line
COPY ./conf/my.cnf /etc/mysql/mysql.conf.d/zzzz-my.cnf
...
RUN ln -s usr/local/bin/docker-entrypoint.sh /docker-entryoint.sh # backwards compat
